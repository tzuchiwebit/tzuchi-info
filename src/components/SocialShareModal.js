...
export default function SocailShareModal({ isOpen, toggleOpen, articleId })  {
  ...
  const sendMessager = () => {
    ...
    const messengerShareUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(link)}`;
    // const messengerShareUrl = 'https://www.facebook.com/dialog/share?app_id=2301035360015086&display=popup&href=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2F'
